...
namespace System.Net
{
    public class ProxyInfo
    {
        ...
        protected static string BypassStringEscape(string rawString)
        {
            var match =
        ...
        protected static string ConvertRegexReservedChars(string rawString)
        {
        ...
        public static ProxyProtocolType? ParseProtocolType(string protocolTypeStr)
        {
            ...
            if (protocolTypeStr.Equals(Uri.UriSchemeHttp, StringComparison.InvariantCultureIgnoreCase))
                protocolType = ProxyProtocolType.Http;
            else if (protocolTypeStr.Equals(Uri.UriSchemeHttps,
        ...
        /// <returns></returns>
        protected static HttpSystemProxyValue ParseProxyValue(string value)
        {
